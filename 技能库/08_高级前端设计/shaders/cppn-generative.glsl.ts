/**
 * CPPN Generative Shader
 * 
 * Compositional Pattern-Producing Network (CPPN) shader that generates
 * organic, neural-network-derived visual patterns. Creates flowing,
 * abstract surfaces with mathematically-driven color transitions.
 * 
 * Perfect for hero backgrounds, loading states, and generative art.
 */
...
import * as THREE from 'three';
import { uniforms, vertexShader, fragmentShader } from './cppn-generative.glsl';
...
export const CPPNMaterial = {
  uniforms,
  vertexShader,
  fragmentShader,
};

export default CPPNMaterial;
